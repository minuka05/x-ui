...
[![Go Report Card](https://goreportcard.com/badge/github.com/minuka05/x-ui)](https://goreportcard.com/report/github.com/minuka05/x-ui)
[![Downloads](https://img.shields.io/github/downloads/minuka05/x-ui/total.svg)](https://img.shields.io/github/downloads/minuka05/x-ui/total.svg)
...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/minuka05/x-ui/master/install.sh)
```
...
```sh
VERSION=1.8.0 && bash <(curl -Ls "https://raw.githubusercontent.com/minuka05/x-ui/$VERSION/install.sh") $VERSION
```
...
wget https://github.com/minuka05/x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
**Step 2:** Clone the Project Repository:
   ...
   ```sh
   git clone https://github.com/minuka05/x-ui.git
   cd x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/minuka05/x-ui.svg)](https://starchart.cc/minuka05/x-ui)
